...
function addLoad(event) {
    ...
    const data = {
        ...
        load_type: loadType,
        magnitude: parseFloat(document.getElementById('loadMagnitude').value),
        location: (['point_x'].includes(loadType)) ? 
                 parseFloat(document.getElementById('loadLocation').value) : null
    };
